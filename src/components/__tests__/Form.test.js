...
describe("Form", () => {
  ...
  it("validates that the student name is not blank", () => {
    ...
    const { getByText } = render(
      <Form interviewers={interviewers} student="" onSave={onSave} interviewer={1} />
    );
  ...
  it("validates that the interviewer cannot be null", () => {
    ...
    const { getByText } = render(
      <Form interviewers={interviewers} student="Lydia Miller-Jones" onSave={onSave} interviewer={null} />
    );
